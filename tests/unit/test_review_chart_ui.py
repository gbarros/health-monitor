...
class ReviewChartUiTest(unittest.TestCase):
    def test_desktop_phase_five_uses_real_week_summary_card_without_fake_chart_data(self) -> None:
        ...
        self.assertIn("WeightTrendChart", week_card)
        self.assertIn("parseKgPerWeek", week_card)
        self.assertIn("loadActiveGoal", week_card)
        ...
        self.assertIn(".weight-trend-chart", styles)
